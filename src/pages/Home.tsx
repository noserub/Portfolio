...
I designed the first touch screen insulin pump interface, revolutionizing how people with diabetes interact with their medical devices and setting the standard for future medical device interfaces.`,
  ...
  return (
    <div className="min-h-screen relative">
      ...
      {/* Hero Section */}
      <section className="min-h-screen flex flex-col items-center justify-center px-6 pt-20 md:pt-32 pb-32 md:pb-40">
        ...
        {/* Quick Stats Section */}
        <section className="w-full max-w-[1400px] mx-auto pt-24 md:pt-32 lg:pt-40 pb-24 md:pb-32 lg:pb-40 relative z-10">
