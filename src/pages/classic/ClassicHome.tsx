...
export function ClassicHome({ onStartClick, isEditMode, onProjectClick, currentPage }: HomeProps) {
            ...
            {isEditingHero ? (
              <div className="space-y-6 p-6 bg-white/90 dark:bg-slate-900/90 backdrop-blur-md rounded-2xl border border-border shadow-lg max-h-[min(85vh,900px)] overflow-y-auto">
                ...
                <div className="space-y-2">
                  ...
                  <Label className="text-xs">Featured case study (modern home)</Label>
                  <p className="text-xs text-muted-foreground mb-2">
                    Shown as the wide hero card at the top of the case study grid. If hidden by a filter, the first visible study is featured instead.
                  </p>
                  <Select
