  ...
  return createPortal(
    ...
    >
      <motion.div
        ...
        className="bg-background rounded-xl border border-border shadow-lg max-w-4xl w-full max-h-[90vh] flex flex-col my-8 relative overflow-hidden"
        style={{ zIndex: 999999 }}
      ...
      >
        ...
        {/* Content */}
        <div className="flex-1 px-6 space-y-6 overflow-y-auto min-h-0 pt-20 pb-20 max-h-[calc(90vh-160px)]">
