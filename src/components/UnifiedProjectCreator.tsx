...
export const UnifiedProjectCreator = React.memo(function UnifiedProjectCreator({ 
  ...
  return createPortal(
    ...
    >
      ...
      >
        {/* Header */}
        <div className="flex items-center justify-between p-6 border-b border-border bg-background sticky top-0 z-10 flex-shrink-0">
        ...
        {/* Footer */}
        <div className="flex items-center justify-end space-x-3 p-6 border-t border-border bg-background sticky bottom-0 z-10 flex-shrink-0">
          <Button
            variant="outline"
            onClick={handleCancel}
            disabled={isCreating}
