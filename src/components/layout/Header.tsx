    ...
    >
      <div className="container mx-auto px-6 py-4 flex items-center justify-center">
        ...
        >
          ...
          {/* Mobile-friendly fallback logo that always shows */}
          <div className="h-12 w-32 bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg flex items-center justify-center backdrop-blur-sm hover:opacity-80 transition-opacity shadow-lg">
