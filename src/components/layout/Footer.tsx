            ...
            >
              ...
              <Tooltip delayDuration={300}>
                ...
                <FooterTooltipContent 
                  sideOffset={8}
                >
                  <p className="text-white dark:text-gray-900">View my profile on LinkedIn</p>
                </FooterTooltipContent>
              </Tooltip>
              ...
              <Tooltip delayDuration={300}>
                ...
                <FooterTooltipContent 
                  sideOffset={8}
                >
                  <p className="text-white dark:text-gray-900">Checkout my GitHub</p>
                </FooterTooltipContent>
              </Tooltip>
              ...
              <Tooltip delayDuration={300}>
                ...
                <FooterTooltipContent 
                  sideOffset={8}
                >
                  <p className="text-white dark:text-gray-900">Send me an email</p>
                </FooterTooltipContent>
              </Tooltip>
            </motion.div>
